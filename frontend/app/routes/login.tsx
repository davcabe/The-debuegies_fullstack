...
export const action: ActionFunction = async ({ request }) => {
  ...
  // Simular login (reemplazar luego por fetch real)
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-100">
      <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-md">
        ...
        {actionData?.errors?.general && <p className="text-red-500 text-xs italic mb-4 text-center">{actionData.errors.general}</p>}
        <Form method="post">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/register" className="text-sm text-blue-500 hover:text-blue-800 font-bold">Register</Link>
          </div>
        </Form>
      </div>
    </div>
