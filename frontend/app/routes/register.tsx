  ...
  return (
    <div className="mb-4">
      ...
      <input
        ...
        className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-slate-300 leading-tight focus:outline-none focus:shadow-outline ${error ? "border-red-500" : ""}`}
      />
